        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.of(context).push(
              MaterialPageRoute<void>(builder: (_) => const BodyTryOnScreen()),
            ),
          ),
        ],
      ),
  ...
  Widget _missingGarmentImage() {
    return Center(
      child: Container(
        ...
        child: const Text(
          'Esta prenda no tiene una imagen utilizable en el vestidor. Puedes consultar sus tallas y volver a intentarlo.',
          textAlign: TextAlign.center,
