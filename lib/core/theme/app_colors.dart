...
class AppColors {
  ...
  static const Color lime = Color(0xFFDFFF3F);         // --dm-lime (Drape Lime insignia)
  ...
  static const Color forest = Color(0xFF10110F);       // Replaced dark green with Atelier Ink
  ...
  static const Color paperDark = Color(0xFFF0F1EB);    // --dm-gray-100 / surface-soft
