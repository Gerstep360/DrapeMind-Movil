...
class _CartScreenState extends State<CartScreen> {
  ...
  void _consultAiStylist() {
    ...
    ai.sendMessage('Mira mi carrito y dime que puedo quitar o que puedo combinar en mi eleccion');
              ...
              : Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          AppSvg.raw(AppSvg.sparkle, size: 22, color: AppColors.forest),
                                  ...
                                  Row(
                                    children: [
                                      IconButton(
                                        ...
                                        icon: AppSvg.raw(AppSvg.minus, size: 14, color: AppColors.forest),
                                      ...
                                      IconButton(
                                        padding: EdgeInsets.zero,
                                        constraints: const BoxConstraints(),
                                        icon: AppSvg.raw(AppSvg.plus, size: 14, color: AppColors.forest),
                                        onPressed: () => _updateQuantity(item, 1),
                                      ),
                                    ],
                                  ),
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  AppSvg.raw(AppSvg.package, size: 16, color: AppColors.white),
                                  const SizedBox(width: 8),
