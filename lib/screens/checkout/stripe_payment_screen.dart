...
class _StripePaymentScreenState extends State<StripePaymentScreen> {
  ...
  Future<void> _initPayment() async {
    ...
    try {
      ...
      final isRealKey = pubKey.startsWith('pk_test_') || pubKey.startsWith('pk_live_');
  ...
  Future<void> _poll(int attempt) async {
    ...
    if (!payment.isPaid && payment.estado == PaymentStatus.pendiente && attempt < 9) {
      _pollTimer = Timer(const Duration(seconds: 2), () {
        _poll(attempt + 1).catchError((_) {
          if (mounted) {
            setState(() => _error = 'Confirmación pendiente. Revisa Mis compras.');
          }
        });
      });
    }
  ...
  Widget build(BuildContext context) {
    final isApproved = _payment?.isPaid == true || _payment?.estado == PaymentStatus.aprobado;
                ...
                children: [
                  ...
                  if (isApproved) ...[
                    ...
                    FilledButton(
                      ...
                      child: const Text('Volver a Mis Pedidos', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ] else ...[
                    ...
                    // PAY BUTTON
                    FilledButton(
                      onPressed: _busy ? null : (_isSandbox ? _paySandbox : _payRealStripe),
                      style: FilledButton.styleFrom(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: _isSandbox ? AppColors.lime : const Color(0xFF4ADE80),
                    fontSize: 10,
