  ...
  void _createReservation() async {
    ...
    final confirm = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Se apartará la prenda ${_product!.nombre} (${_selectedVariant!.color}, Talla ${_selectedVariant!.talla}) durante 48 horas para probártela en el atelier.',
                                      ...
                                      Wrap(
                                       ...
                                       InkWell(
                                         ...
                                         child: Container(
                                           ...
                                           child: Row(
                                             children: [
                                               AppSvg.raw(AppSvg.sparkle, size: 20, color: AppColors.acid),
                                               ...
                                               const Icon(Icons.arrow_forward_ios, size: 14, color: AppColors.acid),
                                             ],
                                           ),
                                         ),
                                       ),
                                ...
                                Expanded(
                                  child: OutlinedButton(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        AppSvg.raw(AppSvg.clock, size: 16, color: AppColors.forest),
                                        const SizedBox(width: 6),
                                        const Text('Reservar 48h'),
                                      ],
                                    ),
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        AppSvg.raw(AppSvg.bag, size: 16, color: AppColors.white),
                                        const SizedBox(width: 6),
